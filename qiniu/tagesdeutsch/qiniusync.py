...
#-*- coding:utf-8 -*-
# 
# 上传代码 python qiniusync.py
# 下载代码 python qiniusync.py down
...
access_key = 'uFEajbg_4gS8q0vMNR2mchCXffH0WYwtL6Rqm8cl'
secret_key = 'Gqg---DpM17-jSqfCPJUUN3M2eRgyIDHhfdAv7_T'
bucket_name = 'tagesdeutsch'
bucket_domain = 'qiniu.tagesdeutsch.com'
...
def upload_file(key,localfile):
    ...
    ret, info = qiniu.put_file(token, key, localfile, params, progress_handler=progress_handler)
